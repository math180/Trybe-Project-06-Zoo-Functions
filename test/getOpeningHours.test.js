...
describe('Testes da função getOpeningHours', () => {
  it('Testa se quando não passado nenhum parâmetro, retorna um objeto com todos os horários', () => {
    const expect = {
    ...
    expect(getOpeningHours()).toEqual(expect);
  });
  ...
  it('Para os argumentos Wednesday e 09:00-PM deve retornar a string: The zoo is closed', () => {
    expect(getOpeningHours('Wednesday', '09:00-AM')).toEqual('The zoo is closed');
  });
